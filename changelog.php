...
<html lang="en">
   ...
   <ul class="html5-compatibility-table">
      ...
      <li>
         <div class="yt-alert yt-alert-naked yt-alert-success  " id="c-video">
            <div class="yt-alert-content" role="alert">    
               This version was modified by me to add the important and changelog button in the guide. 
            </div>
         </div>
      </li>
      </li>
          <div class="yt-alert yt-alert-naked yt-alert-success  " id="c-video">
           ...
           <div class="yt-alert yt-alert-naked yt-alert-success  " id="c-video">
            <div class="yt-alert-content" role="alert">    
               This version was modified by me to fix some issues in crazy frog's original version. 
         </div>
        </div>
      </li>
      </li>
          ...
          <div class="yt-alert yt-alert-naked yt-alert-success  " id="c-video">
            <div class="yt-alert-content" role="alert">    
               This is the original version by crazy frog. 
            </div>
         </div>
      </li>
      </li> 
