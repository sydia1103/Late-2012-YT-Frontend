...
<html lang="en">
   ...
   <body dir="ltr" class="  ltr        site-left-aligned    exp-new-site-width exp-watch7-comment-ui hitchhiker-enabled
      ...
      <div id="page" class="home     branded-page-v2-detached-top "><div id="content" style="">
   <br>
   <h3> This is not by me. It was just modified by me to make it work correctly, all credit goes to crazy frog! This instance could go down at any moment! If it does, please post it in the GoodTube server. </h3>
      ...
      <li>
         <div class="yt-alert yt-alert-naked yt-alert-success  " id="c-video">
            <div class="yt-alert-content" role="alert">    
               <a href="/" class="yt-alert-message">Back to home page</a>
            </div>
         </div>
      </li>
      <li>
         <div class="yt-alert yt-alert-naked yt-alert-success  " id="c-video">
            <div class="yt-alert-content" role="alert">    
               <a href="https://youtube.com" class="yt-alert-message">Normal YouTube</a>
            </div>
         </div>
      </li>
   </ul>
